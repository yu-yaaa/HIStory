...
logo_img_rect.center = (screen_width // 2, screen_height // 8.5)
login_box, login_box_rect, box_height, box_width = draw_white_box(1.5)

def run_register_display(login_box, login_box_rect):
...
gmail_field = TextInput(x = login_box_rect.left + 30, 
...
user_field = TextInput(x = login_box_rect.left + 30, 
                           y = login_box_rect.top + int(box_height * 0.365),
                           width = int(box_width - 60),
                           height = int(box_height * 0.06),
                           font_size = int(screen_height * 0.035))

password_field = TextInput(x = login_box_rect.left + 30, 
...
comfirm_password_field = TextInput(x = login_box_rect.left + 30, 
...
student_role_button = Button("Student",
...
teacher_role_button = Button("Teacher",
...
show_comfirm_password_button = Button("SHOW", 
                    x =login_box_rect.left + int(box_width * 0.75),
                    y = login_box_rect.top + int(box_height * 0.665), 
                    w = int(box_width * 0.22),
                    h = int(box_height * 0.06),
...
login_button = Button("Have an account? Log In Here", 
